...
export function Model(props) {
	...
	const [tireColor, settireColor] = useState("white")
	...
	useFrame(({ clock }) => {
		...
		// 	tireRef.current.rotation.y = clock.getElapsedTime()
		// tireRef.current.material.color = "black"
		// console.log(tireRef.current.material.color)
		// 	// tireRef.current.scale.y = Math.sin(clock.getElapsedTime()) + 3
		...
		<group {...props} dispose={null}>
			<group
				...
				<mesh
					...
					material={materials.McLAREN_sidelogo}></mesh>
				<mesh
				...
				<mesh
					...
					material={materials.material}></mesh>
				<mesh
